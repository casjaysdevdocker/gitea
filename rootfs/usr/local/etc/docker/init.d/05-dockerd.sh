...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202408021830-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  05-dockerd.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Friday, Aug 02, 2024 18:30 EDT
# @@File             :  05-dockerd.sh
# @@Description      :
...
DOCKER_REGISTRIES="${DOCKER_REGISTRIES:-$REGISTERY}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__update_conf_files() {
  ...
  [ -L "$VAR_DIR" ] || __symlink "$DATA_DIR" "$VAR_DIR"
  [ -d "$HOME/.docker" ] && [ -d "/home/docker" ] && cp -Rf "$HOME/.docker"* "/home/.docker"
