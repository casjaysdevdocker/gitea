...
# - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202511290740-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  zz-act_runner.sh --help
# @@Copyright        :  Copyright: (c) 2025 Jason Hempstead, Casjays Developments
# @@Created          :  Saturday, Nov 29, 2025 07:40 EST
...
[ -z "$ACT_RUNNER_APPNAME_ENABLED" ] || if [ "$ACT_RUNNER_APPNAME_ENABLED" != "yes" ]; then export SERVICE_DISABLED="$SERVICE_NAME" && __script_exit 0; fi
# - - - - - - - - - - - - - - - - - - - - - - - - -
